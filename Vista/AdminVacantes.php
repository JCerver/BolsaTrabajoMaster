...
<table class="table table-bordered">
            <tr class="bg-info">
            <th>ID</th><th>Nombre de la empresa</th><th>Puesto</th><th>Salario</th><th>Fecha de publicacion</th><th colspan="3">Accion</th>
            </tr>
<?php
 $ps = "SELECT * FROM tbl_vacante;";
...
?>
            ...
            <tr>
                ...
                <input type="hidden" name="codEliminarVacante" value="<?php echo $row['id_vacante'];?>">
                <button type="submit" name="btnEliminarVacante" class="btn btn-danger">Eliminar</button>
                </form>
                <!--
