...
<table class="table table-bordered">
            <tr class="bg-info">
            <th>ID</th><th>Nombre del curso</th><th>Empresa autora</th><th>Tipo</th><th>Fecha inicio</th><th>Costo</th><th>Categoria</th><th colspan="3">Accion</th>
            </tr>
<?php
...
?>
            ...
            <tr>
                ...
                <td><?php echo $row['cur_fechaInicio'] ?></td>
                 <td><?php echo $row['cur_costo'] ?></td>
                 <td><?php echo $row['cur_categoria'] ?></td>
                <td>
                <form action="../Controlador/Administrador/crudAdministrador.php" method="post">
                <input type="hidden" name="codEliminarCurso" value="<?php echo $row['id_curso'];?>">
                <button type="submit" name="btnEliminarCurso" class="btn btn-danger">Eliminar</button>
                </form>
                <!--
