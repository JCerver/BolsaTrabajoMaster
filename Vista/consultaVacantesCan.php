...
<nav class="navbar navbar-default navbar-static-top">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="consultaVacantesCan.php">Vacantes Publicadas Actualmente</a>
    </div>
...
<table class="table table-bordered" >
            <tr class="bg-info">
            <th>Nombre </th><th>Nombre vacante</th><th>Salario</th><th>Horario</th><th>Descripcion</th><th>Fecha</th><th colspan="3">Accion</th>
            </tr>
<?php
...
?>
            <tr>
                ...
                <td>
                <form action="consultaVacantesPostulados.php" method="post">
                  <input type="hidden" name="idVacante" value="<?php echo $row['id_vacante'];?>">
                  <input type="hidden" name="nomVacante" value="<?php echo $row['vac_nombre'];?>">
                  <button type="submit" name="btnConsultar" class="btn btn-success">Ver Candidatos</button>
                </form>
