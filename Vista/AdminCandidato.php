...
<table class="table table-bordered">
            <tr class="bg-info">
            <th>ID</th><th>Nombre</th><th>Apellido</th><th>Telefono</th><th>E-mail</th><th>Username</th><th colspan="3">Accion</th>
            </tr>
<?php
 $ps = "SELECT * FROM tbl_candidato;";
...
?>
            ...
            <tr>
                ...
                <td><?php echo $row['can_nombre'] ?></td>
                <td><?php echo $row['can_apellido'] ?></td>
                <td><?php echo $row['can_telefono'] ?></td>
                <td><?php echo $row['can_email'] ?></td>
                 <td><?php echo $row['can_username'] ?></td>
                <td>
                <form action="../Controlador/Administrador/crudAdministrador.php" method="post">
                <input type="hidden" name="codEliminarCandidato" value="<?php echo $row['id_candidato'];?>">
                <button type="submit" name="btnEliminarCandidato" class="btn btn-danger">Eliminar</button>
                </form>
                <!--
